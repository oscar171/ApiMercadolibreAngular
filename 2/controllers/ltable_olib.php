<?php
if (class_exists('lt_addbuttons')) exit;
...
function autovar($varname, $default='')
{
	...
	if ($varname == 'uid' || $varname == 'sysuid') $valor = isset($_SESSION['uid']) ? $_SESSION['uid']+0: $_COOKIE['uid']+0;
	if ($varname == 'tienda_id' || $varname == 'tid') $valor = isset($_SESSION['tid']) ? $_SESSION['tid']+0: 99;
	if ($varname == 'proyecto_id' || $varname == 'pid') $valor = isset($_SESSION['pid']) ? $_SESSION['pid']+0: $_COOKIE['pid']+0;
