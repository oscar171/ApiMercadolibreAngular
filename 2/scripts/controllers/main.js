          ...
          if (response.data.id=="new_order")
             {
              ...
              var num3=response.data.data.telefonoseller;           
              ...
              var sellertext="Tienes una nueva compra";
              $http.jsonp('https://www.orioncorp.com.ve/mprs/sms_enviar.php?numero='+num3+'&texto='+sellertext)
              .then(function(response)
                {
                console.log(response);
                })
